...
public class ErrorPacket extends PacketFactory {
    ...
    public void setErrorMessage(String error){ this.message = error; }

    public int getErrorCode() {
        return errorCode;
    }
    public void setErrorCode(int codeNum){
        this.errorCode = codeNum;
    }
